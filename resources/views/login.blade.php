...
<body class="d-flex align-items-center bg-body-tertiary py-4">
    ...
    <main class="form-signin w-100 m-auto px-3 text-center">
        <form method="POST" action="{{route('documentation.process.login')}}">
            @csrf
            {{-- <img class="mb-4" src="" alt="" width="180"> --}}
            <h1 class="h3 fw-normal mb-3">Please sign in</h1>

            <div class="form-floating">
                <input type="string" class="form-control" id="floatingInput" name="email" placeholder="admin">
            ...
            <p class="text-body-secondary mb-3 mt-5">©2023</p>
        </form>
    </main>
