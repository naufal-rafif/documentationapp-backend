...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            // User Management
            ['name' => 'view-users', 'guard_name' => 'api', 'group_id' => 'User', 'label' => 'View User', 'description' => 'For View User', 'level' => 3],
            ['name' => 'create-users', 'guard_name' => 'api', 'group_id' => 'User', 'label' => 'Create User', 'description' => 'For Create User', 'level' => 3],
            ['name' => 'edit-users', 'guard_name' => 'api', 'group_id' => 'User', 'label' => 'Edit User', 'description' => 'For Edit User', 'level' => 3],
            ['name' => 'delete-users', 'guard_name' => 'api', 'group_id' => 'User', 'label' => 'Delete User', 'description' => 'For Delete User', 'level' => 3],
            ['name' => 'view-profile', 'guard_name' => 'api', 'group_id' => 'User', 'label' => 'View Profile', 'description' => 'For View Profile', 'level' => 10],
